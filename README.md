...
Features a dashboard with net worth tracking, per-account balances, a searchable transaction log with custom tags, and an insights view with cash flow charts and spending breakdowns by category. Built with Flutter and Dart, with a GitHub Actions CI pipeline throughout.
